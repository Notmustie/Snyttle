...
| Reasoning effort | **Adaptive thinking, per-agent effort** (Planner/Critic high, Research/RAG low) | Claude 4.6+ uses effort, not budget_tokens; spend tokens where they pay off |
